const CACHE = 'tallyho-v19-storekit-only-premium';
const FILES = ['./', './index.html', './privacy.html', './styles.css', './app.js', './manifest.webmanifest', './icon.jpeg', './icon-192.png', './icon-512.png'];
