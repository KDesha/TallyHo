...
function init(){setDocumentLocale();bind();bindOnboarding();bindThemeControls();initAuth();renderAll();if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js').catch(()=>{})}
